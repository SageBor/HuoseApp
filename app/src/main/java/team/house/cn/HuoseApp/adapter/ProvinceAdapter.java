...
public class ProvinceAdapter extends BaseAdapter implements SpinnerAdapter {
    ...
    private ArrayList<ProvinceBean> spinnerList;

    public ProvinceAdapter(ArrayList<ProvinceBean> spinnerList, Context _context) {
...
//        LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        text.setText(spinnerList.get(i).getPro_name());
        return text;
    }
